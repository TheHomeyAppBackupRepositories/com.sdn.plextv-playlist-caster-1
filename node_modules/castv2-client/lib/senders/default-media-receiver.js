...
DefaultMediaReceiver.prototype.next = function(currentTime, callback) {
  this.media.next.apply(this.media, arguments);
};

DefaultMediaReceiver.prototype.prev = function(currentTime, callback) {
  this.media.prev.apply(this.media, arguments);
};
